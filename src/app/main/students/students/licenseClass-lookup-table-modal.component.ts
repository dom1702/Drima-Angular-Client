...
import {StudentsServiceProxy, StudentLicenseClassLookupTableDto } from '@shared/service-proxies/service-proxies';
...
export class LicenseClassLookupTableModalComponent extends AppComponentBase {
    ...
    setAndSave(licenseClass: StudentLicenseClassLookupTableDto) {
